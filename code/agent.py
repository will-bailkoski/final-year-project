...
class IndependentQLearning(Agent):
    ...
    def __init__(self, agent_name, length_of_episode):
        ...
        """
        self.episode = 0
        self.gamma = 0.8  # iql_hyperparameters['gamma']
        self.greedy_value = 0.5  # iql_hyperparameters['greedy']
        self.alpha = 0.8  # iql_hyperparameters['alpha']
...
class IndependentQLearningEmergentCoop(Agent):
    """Each Agent learns its own Q-Table"""
