...
class World:  # multi-agent world
    ...
    def step(self):
        ...
        p_force = [None] * len(self.landmarks)
       # print(p_force)
        ...
        for entity in self.landmarks:
            #print(entity)
            self.update_agent_state(entity)
    ...
    def apply_action_force(self, p_force):
        # set applied forces
        for i, agent in enumerate(self.landmarks):
            if agent.movable:
                # noise = (
    ...
    def integrate_state(self, p_force):    
        #print(f'p_force: { p_force }') 
        for i, entity in enumerate(self.landmarks):
            #print(f'index: {i} and entity: {entity}')
    ...
    def get_collision_force(self, entity_a, entity_b):
        ...
        dist_pent = dist*penetration
        # if  dist_pent == 0.0:
        #     dist_pent = 0.000001
        force = self.contact_force * delta_pos / dist_pent
